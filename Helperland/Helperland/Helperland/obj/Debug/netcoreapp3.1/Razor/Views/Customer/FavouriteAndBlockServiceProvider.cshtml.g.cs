#pragma checksum "F:\PSD TO HTML\website\Helperland\Helperland\Helperland\Views\Customer\FavouriteAndBlockServiceProvider.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "39c60b80c62f92e4586ec80f3d451ea0c7a42418"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"39c60b80c62f92e4586ec80f3d451ea0c7a42418", @"/Views/Customer/FavouriteAndBlockServiceProvider.cshtml")]
                ...
                success: function (respo) {
                    ...
                    respo.forEach(function (element) {
                        ...
                        if (element.blockeduser != null) {
                            btnnbandu = '<button class=""btn");
                WriteLiteral(@" btn-danger btn-Accept btn-rounded-17 btn-blockUnblock"" onclick=""BlockUnBlockAndFavUnFav(' + element.customeruserid + ')"" value=""UnBlock"">UnBlock</button>'
                        }
                        else {
...
");
                WriteLiteral(@"                            if (element.spblock == false) {
                            ...
                            if (element.spfav == false) {
                                ...
                                btnfav");
                WriteLiteral(@" = '<button class=""btn btn-danger btn-Accept btn-rounded-17 btn-blockUnblock"" onclick=""BlockUnBlockAndFavUnFav(' + element.spid + ',false,' + element.spblock + ')"" value=""UnBlock"">UnFav</button>'
                            }
                        }
                        else {
