#pragma checksum "F:\PSD TO HTML\website\Helperland\Helperland\Helperland\Views\ServiceProvider\ServiceHistory.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c2cdc3bb2fea2a91d73eb5d2e3ccb7989cd53395"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c2cdc3bb2fea2a91d73eb5d2e3ccb7989cd53395", @"/Views/ServiceProvider/ServiceHistory.cshtml")]
            ...
            $.ajax({
                ...
                WriteLiteral(@"me = AppendZero(date.getHours().toString()) + "":"" + AppendZero(date.getMinutes().toString()) + "" - "" + AppendZero(d2.getHours().toString()) + "":"" + AppendZero(d2.getMinutes().toString())
                        ...
                        t.row.add([
                            ...
                            '<span class=""d-none"">' + spandate +'</span><img src=""..//img/service-provider-upcoming-service/calendar2.png"" alt=""""><span class=""bold"">' + inputtagdate + '</span> <br><img src=""..//img/service-pro");
                WriteLiteral(@"vider-upcoming-service/layer-712.png"" alt="""">' + temptime,
...
");
                ...
                success: function (respo) {
                    ...
                    document.getElementById(""serviceproviderserviceaddress"").innerHTML = respo.user.serviceRequ");
                WriteLiteral(@"estAddresses[0].addressLine1 +
                    ...
                    if (respo.user.hasPets == true) {
                        ...
                        document.getElementById(""serviceproviderpet"").innerHTML = '<img src=""..//img/customer-service/not-in");
                WriteLiteral(@"cluded.png"" alt="""" /> I don' + ""'"" + 't have pets at home'
                    }
