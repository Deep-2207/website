#pragma checksum "F:\PSD TO HTML\website\Helperland\Helperland\Helperland\Views\ServiceProvider\UpcomingServices.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cd32beb36872971c888132539d4091082c8420eb"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cd32beb36872971c888132539d4091082c8420eb", @"/Views/ServiceProvider/UpcomingServices.cshtml")]
        ...
        function UpcomingService() {
            ...
            $.ajax({
                ...
                WriteLiteral(@") {
                        ...
                        t.row.add([
                            '<span class=""tdclick""> <a onclick=""showservicerequestdetailmodel(' + element.serviceid + ");
                WriteLiteral(@"',2)"" class=""startid d-flex justify-content-center align-items-center"" href=""#""> ' + element.serviceid + '</a></span>',
                            ...
                            '',
                            '<button id=""completed' + element.serviceid + '"" class=""btn btn-Accept btn-completedsr btn-rounded-17 me-1"" onclick=""Completed(' +");
                WriteLiteral(@" element.serviceid + ')"" value=""Completed"">Completed</button><button class=""btn btn-danger btn-rounded-17"" onclick=""Cancel(' + element.serviceid + ')"" value=""Cancel"">Cancel</button>'
                        ]).draw(false);
                        console.log();
                        var date1 = d2;
                        var date2 = new Date();
        ...
        function showservicerequestdetailmodel(id, index) {
            ...
            $.ajax({
                ...
                success: function (respo) {
                    console.log(respo);
                    $(""#loader"").removeClass(""is-active"");
                    document.getElementById(""serviceproviderd&t"").innerHTML = respo.user");
                WriteLiteral(@".serviceStartDate;
                    ...
                    document.getElementById(""serviceproviderpho");
                WriteLiteral(@"nenumber"").innerHTML = respo.user.serviceRequestAddresses[0].mobile;
