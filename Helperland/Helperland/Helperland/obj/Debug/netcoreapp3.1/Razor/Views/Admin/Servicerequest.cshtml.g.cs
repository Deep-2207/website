#pragma checksum "F:\PSD TO HTML\website\Helperland\Helperland\Helperland\Views\Admin\Servicerequest.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d337236534a845fa8c16197ef0cacbf85d28edcd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d337236534a845fa8c16197ef0cacbf85d28edcd", @"/Views/Admin/Servicerequest.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "d337236534a845fa8c16197ef0cacbf85d28edcd6467", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d337236534a845fa8c16197ef0cacbf85d28edcd7660", async() => {
                WriteLiteral(@"
        <div class=""form-row align-items-center d-flex justify-content-center dv-filter"">
            ...
            <div class=""col form-group"">
                ...
                <select id=""idcustomerdrp"" class=""form-select width-127"">
                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d337236534a845fa8c16197ef0cacbf85d28edcd8502", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d337236534a845fa8c16197ef0cacbf85d28edcd10393", async() => {
                    WriteLiteral("...");
                }
                );
                __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d337236534a845fa8c16197ef0cacbf85d28edcd11643", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d337236534a845fa8c16197ef0cacbf85d28edcd13735", async() => {
                    WriteLiteral("Status");
                }
                );
                __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
...
#nullable disable
                WriteLiteral("                        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d337236534a845fa8c16197ef0cacbf85d28edcd15941", async() => {
#nullable restore
...
#nullable disable
    ...
    <script>
        ...
        $(""#idsubmit"").click(function () {
            ...
            if (servicerequest != '') {
                t.column(0).search(""^"" + servicerequest ");
                WriteLiteral(@"+ ""$"", true, false, true).draw(true);
            }
            ...
            jQuery.fn.dataTable.ext.search.push(
                function (settings, data, dataIndex) {
                    ...
                    if ($(""#txtsrFromDate"").val() != '' && $(""#idtodate"").val() != '') {
                        ...
                        max = new Date(parseInt($(""#txtsrtoDate"").val().toString().split('-')[0]), parseInt(parseInt($(""#txtsrtoDate"").val().toString().split('-')[1]) - 1), parseInt($(""#");
                WriteLiteral(@"txtsrtoDate"").val().toString().split('-')[2]), 0, 0, 0, 0);
                    }
        ...
        function Editservicerequest(serviceid) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    var today = new Date();
                    $(""#admindatechange"").attr(""min"", (today.ge");
                WriteLiteral(@"tFullYear().toString() + '-' + AppendZero((today.getMonth() + 1).toString()) + '-' + AppendZero(today.getDate().toString())));
       ...
       ");
        ...
        function editandreschedul() {
            ...
            if ($(""#admintxtpostalcode"").val() == """") {
               ");
                WriteLiteral(@" $(""#spnpostalcodeerrormesg"").html(""Please Enter PostalCode"");
            }
            else {
                ...
                $(""#admintxtpostalcode"").val() != """" && $(""#spnpostalcodeerrormesg"").html() == """")
            {
                ...
                editdata.PostalCode = $(""#");
                WriteLiteral(@"admintxtpostalcode"").val();
                ...
                $.ajax({
                    ...
                    success: function (respo) {
                        ...
                        if (respo.serviceovertime == false) {
                            $(""#adminerrormesgrechedual"").removeClass("" d-none"")
            ");
                WriteLiteral(@"                $(""#adminerrormesgrechedual"").html(""Could not completed the service request, because service booking request is must be completed within 21:00 time"");
                        }
  ...
  ");
                WriteLiteral(@"      $(""#txtsrtoDate"").change(function () {
            $(""#txtsrFromDate"").attr({
                ""max"": $(""#txtsrtoDate"").val(),
            });
        });
