#pragma checksum "F:\PSD TO HTML\website\Helperland\Helperland\Helperland\Views\ServiceProvider\NewServiceRequest.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0fb125af6bc361ee871c186469881f451209a1f2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0fb125af6bc361ee871c186469881f451209a1f2", @"/Views/ServiceProvider/NewServiceRequest.cshtml")]
...
#nullable disable
  ...
  ");
   ...
   ");
                WriteLiteral(@"             data: { ""servicerequestid"": id },
                success: function (respo) {
                    console.log(respo);
                    ...
                    document.getElementById(""serviceproviderserviceaddress"").innerHTML = respo.user.serviceRequestAddresses[0].addressLine1 +
                        respo.user.serviceRequestAddresses[0].addressLi");
                WriteLiteral(@"ne2 + '<br>' +
                    ...
                    if (respo.user.hasPets == true) {
                        document.getElementById(""serviceproviderpet"").innerHTML = '<img src=""..//img/customer-service/included.png"" alt="""" /> I");
                WriteLiteral(@" have pets at home'
                        // alert(""pet che"");
                    }
                    else {
                    ...
                    var inputTagDate = date.getFullYea");
                WriteLiteral(@"r().toString() + ""-"" + AppendZero((date.getMonth() + 1).toString()) + ""-"" + AppendZero(date.getDate().toString());
