#pragma checksum "F:\PSD TO HTML\website\Helperland\Helperland\Helperland\Views\ServiceProvider\NewServiceRequest.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8294dfb941de34637f02add2b94519be4b211957"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8294dfb941de34637f02add2b94519be4b211957", @"/Views/ServiceProvider/NewServiceRequest.cshtml")]
  ...
  ");
                ...
                success: function (resp) {
                    ...
                    if (resp.noLongerAvailable == true) {
                        ...
                        /");
                WriteLiteral(@"*showSPNewServiceRequestsData(document.getElementById(""hasPetsForNewRequestsOfSP"").checked);*/
                        afterload();
                    }
        ...
        function showservicerequestdetailmodel(id, index) {
            ...
            $.ajax({
                ...
                success: function (respo) {
                    ...
                    document.getElementById(""serviceprovidersrid"").innerHTML = respo.user.serviceReques");
                WriteLiteral(@"tId;
                    ...
                    document.getElem");
                WriteLiteral(@"entById(""serviceprovidercomments"").innerHTML = respo.user.comments;
                    ...
                    if (index == 0) {
                        document.getElementById(""btnreschedulejsdashbord"").innerHTML = '<hr ");
                WriteLiteral(@"/><button class=""btn btnReschedule d-inline-block"" value="""" onclick=""rescheduleservicemodel()"">Reschedule</button><button class=""btn btncancel d-inline-block pl-2"" value = """" onclick=""canelservicemodel()""> Cancel</button>';
                    }
                    else {
